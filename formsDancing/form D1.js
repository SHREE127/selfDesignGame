class dance_form{
    ...
    display(){
        ...
        this.button1.mousePressed(()=>{
            ...
            this.hide();
            DANCING1_form= new easy_Dancing();
            DANCING1_form.display();
         })
         this.button2.mousePressed(()=>{
             this.hide();
             DANCING2_form= new medium_Dancing();
             DANCING2_form.display();
         })
         this.button3.mousePressed(()=>{
             this.hide();
             DANCING3_form= new hard_Dancing();
             DANCING3_form.display();
         })
         this.button4.mousePressed(()=>{
             this.hide();
             DANCING4_form= new expert_Dancing();
             DANCING4_form.display();
         })
